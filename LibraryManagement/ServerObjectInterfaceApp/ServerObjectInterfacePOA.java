 ...
 implements ServerObjectInterfaceApp.ServerObjectInterfaceOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // ServerObjectInterfaceApp/ServerObjectInterface/listItemAvailability
       {
         String managerID = in.read_string ();
         String $result = null;
       ...
       case 6:  // ServerObjectInterfaceApp/ServerObjectInterface/waitInQueue
       {
         String userID = in.read_string ();
         String itemID = in.read_string ();
         boolean $result = false;
         $result = this.waitInQueue (userID, itemID);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }

       case 7:  // ServerObjectInterfaceApp/ServerObjectInterface/exchangeItem
       {
         String userID = in.read_string ();
       ...
       case 8:  // ServerObjectInterfaceApp/ServerObjectInterface/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
